# App.py Implementation Guide - Task by Task

## Initial Setup (Milestone + Task 1 & 2)
**Files**: `app.py` (basic structure), `base.html`, `home.html`
**Commit Message**: "Initial setup with navigation and home page"
...
## Task 3: Event Customer List
**Files**: Add route to `app.py`, create `eventcustomerlist.html`
**Commit Message**: "Add Task 3: Event customer list with sorting"

```python
# Task 3 : Event : name,date, list of customers purchased ticket in family and youngest order
...
## Task 4: Buy Tickets
**Files**: Add route to `app.py`, create `buytickets.html`
**Commit Message**: "Add Task 4: Buy tickets with validation and age restrictions"
...
**Files**: Add route to `app.py`, create `searchcustomer.html`
**Commit Message**: "Add Task 5: Customer search functionality"
...
## Task 6: Add Customer
**Files**: Add route to `app.py`, create `addcustomer.html`
**Commit Message**: "Add Task 6: Add customer with validation"
...
## Task 7: Edit Customer
**Files**: Add route to `app.py`, create `editcustomer.html`
**Commit Message**: "Add Task 7: Edit customer functionality"
...
## Task 8: Future Events List
**Files**: Add route to `app.py`, create `futureevents.html`
**Commit Message**: "Add Task 8: Future events with available tickets"

```python
# Task 8 : Future Events with Tickets Remaining 
...
## Task 9: Customer Ticket Summary + Customers List
**Files**: Add routes to `app.py`, create `customerdetails.html`, `customers.html`
**Commit Message**: "Add Task 9: Customer details and ticket summary"
...
1. **Commit 1**: "Initial setup with navigation and home page" (Milestone + Tasks 1&2)
2. **Commit 2**: "Add Task 3: Event customer list with sorting"
3. **Commit 3**: "Add Task 4: Buy tickets with validation and age restrictions"
4. **Commit 4**: "Add Task 5: Customer search functionality"
5. **Commit 5**: "Add Task 6: Add customer with validation"
6. **Commit 6**: "Add Task 7: Edit customer functionality"
7. **Commit 7**: "Add Task 8: Future events with available tickets"
8. **Commit 8**: "Add Task 9: Customer details and ticket summary"
9. **Commit 9**: "Add all HTML templates and styling"
10. **Commit 10**: "Add Task 10: Project report and final documentation"

Remember to create the corresponding HTML templates for each task as you implement the routes!